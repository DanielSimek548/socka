...
public class StudentUpdate extends javax.swing.JFrame {
    ...
    public StudentUpdate() {
        initComponents();
        this.setExtendedState(StudentUpdate.MAXIMIZED_BOTH);
    }
    ...
    private void initComponents() {
        ...
        classR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                classRActionPerformed(evt);
            }
        });

        locker.setEditable(false);
    ...
    private void submitBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBActionPerformed
        try {
            ...
            String sql = "UPDATE `soc`.`student` SET meno=?, priezvisko=?, mobil=?, email=?, ulica=?, cisloDomu=?, psc=?, mesto=?, trieda=?;";

            if (name.getText().isEmpty() && surname.getText().isEmpty() && classR.getText().isEmpty() && locker.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "This fields are required: Meno, Priezvisko, Trieda");
            } else {
                ...
                pst.setString(9, classR.getText());
                pst.executeUpdate();
    ...
    private void lockerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lockerActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT skrinka FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("skrinka");
            locker.setText(data);
    ...
    private void nameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nameActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT meno FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("meno");
            name.setText(data);
            System.out.println(data);
    ...
    private void surnameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_surnameActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT priezvisko FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("priezvisko");
    ...
    private void streetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_streetActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT ulica FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("ulica");
            street.setText(data);
    ...
    private void aNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aNumberActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT cisloDomu FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("cisloDomu");
            aNumber.setText(data);
    ...
    private void townActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_townActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT mesto FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("mesto");
            town.setText(data);
    ...
    private void sNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sNumberActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT psc FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("psc");
            sNumber.setText(data);
    ...
    private void mobileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mobileActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT mobil FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("mobil");
            mobile.setText(data);
    ...
    private void emailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emailActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT email FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);
    ...
    private void classRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_classRActionPerformed
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/soc", "root", "");
            stmt = con.createStatement();
            String sql = "SELECT trieda FROM `soc`.`student` WHERE id = " + ids + ";";
            rs = stmt.executeQuery(sql);

            rs.next();
            String data = rs.getString("trieda");
            classR.setText(data);

        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex);
        }
    }//GEN-LAST:event_classRActionPerformed
